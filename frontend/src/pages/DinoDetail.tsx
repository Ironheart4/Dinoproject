        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-800 rounded-lg p-3 sm:p-4">
            ...
            {canView3DModel ? (
              ...
              <div className="w-full min-h-[420px] sm:min-h-[560px] lg:min-h-[700px] flex flex-col items-center justify-center bg-gray-900 rounded-lg border-2 border-dashed border-gray-600 p-4">                <Lock size={48} className="text-gray-500 mb-3 sm:mb-4" />
